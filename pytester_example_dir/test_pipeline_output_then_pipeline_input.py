...
@pytest.mark.pipeline_output("step_1_output")  # produce_test_data, share_test_output
def test_step_1(save_output_func: PipelineOutput):
    save_output_func.save_output("Hello World")

@pytest.mark.pipeline_input("step_1_output") # consume_test_data, consume_shared_input
